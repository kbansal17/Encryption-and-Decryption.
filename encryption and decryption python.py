...
def Result():
    ...
    if (i==1):
        ...
        messagebox.showinfo('Please Choose one of Encryption or Decrption')
...
wn.title("Encrypt and Decrypt the Messages")
...
headingLabel = Label(headingFrame1, text=" Welcome to Encryption and Decryption with Brainies", fg='black', font=('Courier',13,'bold'))
headingLabel.place(relx=0,rely=0, relwidth=1, relheight=1)


label1 = Label(wn, text='Write Your Message', font=('Courier',10))
label1.place(x=10,y=150)

msg = Entry(wn,textvariable=Message, width=20, font=('calibre',10,'normal'))
msg.place(x=200,y=150)

label2 = Label(wn, text='Write your key', font=('Courier',10))
label2.place(x=10,y=200)

InpKey = Entry(wn, textvariable=key,  width=20,font=('calibre',10,'normal'))
InpKey.place(x=200,y=200)

label3 = Label(wn, text='Choose encrypt or decrypt', font=('Courier',10))
...
res = Entry(wn,textvariable=Output, width=40, font=('calibre',10,'normal'))
res.place(x=200,y=350)



ShowBtn = Button(wn,text="Show Message",bg='black', fg='white',width=15,height=1,command=Result)
ShowBtn['font'] = font.Font( size=12)
ShowBtn.place(x=180,y=400)

ResetBtn = Button(wn, text='Reset', bg='black', fg='white', width=15,height=1,command=Reset)
ResetBtn['font'] = font.Font( size=12)
ResetBtn.place(x=15,y=400)

QuitBtn = Button(wn, text='Exit', bg='black', fg='white',width=15,height=1, command=wn.destroy)
